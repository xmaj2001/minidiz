...
export default function MembrosPage() {
  const [membros, setMembros] = useState(membrosData)
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            Membro desde {new Date(membro.dataIngresso).toLocaleDateString("pt-BR")}
                          </div>
                        </div>
                      </div>
                    </TableCell>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="nome" placeholder="Digite o nome completo" defaultValue={editingMembro?.nome} />
              </div>
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Textarea
                  ...
                  defaultValue={editingMembro?.observacoes}
                />
              </div>
            </div>
