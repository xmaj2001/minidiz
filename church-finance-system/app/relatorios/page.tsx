      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Visão geral das finanças este mês</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 rounded-lg bg-secondary/10">
                  <div className="text-2xl font-bold text-secondary">
                    {dadosFinanceiros.totalEntradas.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
                  </div>
                  <div className="text-sm text-muted-foreground">Total de Entradas</div>
                </div>
                <div className="text-center p-4 rounded-lg bg-destructive/10">
                  <div className="text-2xl font-bold text-destructive">
                    {dadosFinanceiros.totalSaidas.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
                  </div>
              ...
              <div className="text-center p-4 rounded-lg bg-primary/10">
                <div className="text-3xl font-bold text-primary">
                  {dadosFinanceiros.saldoLiquido.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
                </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Estatísticas dos membros da igreja</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 rounded-lg bg-primary/10">
                  <div className="text-2xl font-bold text-primary">{dadosMembros.totalMembros}</div>
                  <div className="text-sm text-muted-foreground">Total de Membros</div>
                </div>
                <div className="text-center p-4 rounded-lg bg-secondary/10">
                  <div className="text-2xl font-bold text-secondary">{dadosMembros.membrosAtivos}</div>
                  <div className="text-sm text-muted-foreground">Membros Ativos</div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 rounded-lg bg-accent/10">
                  <div className="text-2xl font-bold text-accent">{dadosMembros.novosMembros}</div>
                  <div className="text-sm text-muted-foreground">Novos este Mês</div>
                </div>
                <div className="text-center p-4 rounded-lg bg-secondary/10">
                  <div className="text-2xl font-bold text-secondary">{dadosMembros.dizimistas}</div>
                  <div className="text-sm text-muted-foreground">Dizimistas</div>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {selectedDate ? format(selectedDate, "PPP", { locale: ptBR }) : "Data Específica"}
                  </Button>
                </PopoverTrigger>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Selecione o relatório que deseja gerar</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Distribuição das contribuições por tipo</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 rounded-lg bg-primary/10">
                ...
                <div className="text-2xl font-bold text-primary">
                  {dadosFinanceiros.dizimos.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
                </div>
                <div className="text-sm text-muted-foreground">Dízimos</div>
                <div className="text-xs text-muted-foreground mt-1">
                  {Math.round((dadosFinanceiros.dizimos / dadosFinanceiros.totalEntradas) * 100)}% do total
                </div>
              </div>
              ...
              <div className="text-center p-6 rounded-lg bg-accent/10">
                ...
                <div className="text-2xl font-bold text-accent">
                  {dadosFinanceiros.ofertas.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
                </div>
                <div className="text-sm text-muted-foreground">Ofertas</div>
                <div className="text-xs text-muted-foreground mt-1">
                  {Math.round((dadosFinanceiros.ofertas / dadosFinanceiros.totalEntradas) * 100)}% do total
                </div>
              </div>
              ...
              <div className="text-center p-6 rounded-lg bg-secondary/10">
                ...
                <div className="text-2xl font-bold text-secondary">
                  {dadosFinanceiros.doacoes.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
                </div>
                <div className="text-sm text-muted-foreground">Doações</div>
                <div className="text-xs text-muted-foreground mt-1">
                  {Math.round((dadosFinanceiros.doacoes / dadosFinanceiros.totalEntradas) * 100)}% do total
                </div>
              </div>
            </div>
          </CardContent>
