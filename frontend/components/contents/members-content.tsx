...
import { ListMembers } from "../modules/members/list-members"
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
      ...
      <motion.div className="flex-1 space-y-4" variants={containerVariants} initial="hidden" animate="visible">
        <motion.div variants={itemVariants} className="w-full h-[50px] flex justify-center items-center">
          <Input placeholder="Pesquizar" className="w-2/3 border-none bottom-1"/>
        </motion.div>
